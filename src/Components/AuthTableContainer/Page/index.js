    ...
    return <div className="flex flex-col min-h-screen content-start px-2"  /*style={{backgroundImage: `url(${LightBlueBackground})`}}*/>
        ...
        <div className="flex justify-center my-1  flex-row mt-3 items-center">
            ...
            {localStoreAuth==="true" && <div className="pl-2 font-medium relative cursor-pointer" >
                <OutsideClickHandler
                    onOutsideClick={() => {
                        setShowMenu(false);console.log(localStoreRole);
                    }}
                >
                    ...
                    rounded border-2 border-solid border-gray-700 cursor-auto">
                        {localStoreRole && localStoreRole==='9' && <div className="flex flex-row cursor-pointer items-center mb-2"><Users width="18" height="18" /> <Fac to="/uifac/recurrente/alluser" className="flex ml-2">Todas los Usuarios</Fac></div>}
        ...
        <div className="flex justify-center">
            <div className="flex justify-center w-5/5 lg:w-3/3 md:w-3/3 sm:w-3/3 xs:w-full flex-col">
                {props.children}
            </div>
        </div>
    </div>
