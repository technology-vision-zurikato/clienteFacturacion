...
const FormFac = (props) => {
    const {purchase, setPurchaseDone} = props;
    ...
    return <Form
        ...
        render={({ handleSubmit, form, submitting, pristine, values }) => (
            <form className="form" onSubmit={handleSubmit}>
                ...
                {rediretPurchaseDone && <Redirect to="/uifac/expres/purchase-done" />}
                ...
                <div className="buttons">
                    <BtnButton loading={loading}>Generar Factura</BtnButton>
                </div>
            </form>
        )}
    />
